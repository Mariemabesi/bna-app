...
export default function BarChart() {
  return (
    <div style={{ width: "100%", height: 300, background: "#fff", borderRadius: "12px", padding: "20px" }}>
      <h3 style={{ color: "#550707ff", marginBottom: "10px" }}>Statistiques Mensuelles</h3>
      <ResponsiveContainer width="100%" height="90%">
        <ReBarChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 5 }}>
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="revenus" fill="#00a859" radius={[4, 4, 0, 0]} />
          <Bar dataKey="dépenses" fill="#00703c" radius={[4, 4, 0, 0]} />
        </ReBarChart>
      </ResponsiveContainer>
    </div>
  );
